...
@Component
public class AuthenticationServiceFallback implements FallbackProvider {
    private static final String DEFAULT_MESSAGE = "Authentication service is not available.";
